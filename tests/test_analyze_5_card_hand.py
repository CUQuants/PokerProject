...
class TestAnalyze5Hand(unittest.TestCase):
    ...
    def test_straight(self):
        ...
        self.assertAlmostEqual(analyze5Hand(cards), 4.99, places=2)

        # Test 4
        cards = [Card(10, Suit.CLUBS), Card(11, Suit.SPADES), Card(12, Suit.HEARTS), Card(13, Suit.DIAMONDS), Card(9, Suit.HEARTS)]
        self.assertAlmostEqual(analyze5Hand(cards), 4.88, places=2)
