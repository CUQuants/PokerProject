...
#For now Im seeing the easiest way is to find all 21 combinations of cards and then find the best hand
#add if statements for less than 5, recursively call if greater than 5 cards?
#problem is this can become quite costly running the code 21 times for each hand
#but also is like extremely fucking hard to make this work for 7 I haven't figured that out yet
